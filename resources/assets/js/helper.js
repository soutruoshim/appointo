(function($) {
    ...
    $.easyAjax = function(options) {
        ...
        if (typeof opt.beforeSend != "function") {
            opt.beforeSend = function() {
                ...
                $(opt.container).find(".is-invalid").each(function () {
        ...
        function handleFail(response) {
            ...
            if (typeof response.errors != "undefined") {
                ...
                $(opt.container).find(".form-group").find(".invalid-feedback").remove();
                ...
                if (opt.errorPosition == "field") {
                    for (var i = 0; i < keys.length; i++) {
                        ...
                        $(grp).find('.form-control').addClass("is-invalid");
                    }
    ...
    $.showErrors = function(object) {
        ...
        $(".is-invalid").find(".invalid-feedback").remove();
